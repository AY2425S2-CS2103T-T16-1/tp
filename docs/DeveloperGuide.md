...
|----------|--------|-------------------------------------------------------------------------|----------------|
| `***` | Student | Group contacts under categories such as "Classmates" or "Module"          | Easily locate specific individuals (e.g., peers or professors) when needed |
...
| `***` | Student | Sort contacts by a field                                                | Keep the contact list structured and organized |
